...
DROP DATABASE "postgres-test_test";
...
161	4	06cfc86e1709ccdae621013a45fde070	1
162	4	7ca08c94edf8410476af0e05834ff2cb	1
...
163	6	7ca08c94edf8410476af0e05834ff2cb	1
164	4	6c72b90e5a8c5e8b62c13b44738be78c	2
168	4	580646b1862fcf9d3ac83406cb9124f7	11
...
169	4	6cc9686c162d21334d91fbe4b10f1891	2
...
165	1	6c72b90e5a8c5e8b62c13b44738be78c	4
...
160	1	06cfc86e1709ccdae621013a45fde070	1
170	1	6cc9686c162d21334d91fbe4b10f1891	4
166	4	d85c1075d2a9da4038abf0b1edc041ae	4
167	4	f83b6f4c901f15d2a75e95ab8a0e9b49	10
172	1	8d12b224b2e4e20fcc89743b45e3deb1	12
171	4	8d12b224b2e4e20fcc89743b45e3deb1	80
173	4	ea56b82c41f82fee8442f401f7a5d6db	2
174	1	ea56b82c41f82fee8442f401f7a5d6db	3
176	1	cc158e0437a61488f0fd29cd22293d7b	75
175	4	cc158e0437a61488f0fd29cd22293d7b	15
177	4	6ccb0cfd87e359896b9e3b6b36108977	15
178	1	6ccb0cfd87e359896b9e3b6b36108977	4
179	4	603f5b3fb20f044420fe96e90348af48	2
180	4	9e25a53f71e602bf920096f985c850b5	2
182	1	99d6c3362db5cf190bf02011ab0c5c9d	1
181	4	99d6c3362db5cf190bf02011ab0c5c9d	1
\.
...
DoctrineMigrations\\Version20211225205517	2021-12-25 20:55:40	164
DoctrineMigrations\\Version20211226194122	2021-12-26 19:41:43	140
\.
...
155	06cfc86e1709ccdae621013a45fde070	1	Павел	1231461030	dfg
156	7ca08c94edf8410476af0e05834ff2cb	1	Павел	1231461030	ул Некрасова д.10
157	6c72b90e5a8c5e8b62c13b44738be78c	1	Павел	1231461030	ул Некрасова д.10
158	d85c1075d2a9da4038abf0b1edc041ae	1	Павел	1231461030	ул Некрасова д.10
159	f83b6f4c901f15d2a75e95ab8a0e9b49	1	Павел	1231461030	ул Некрасова д.10
160	580646b1862fcf9d3ac83406cb9124f7	1	Павел	1231461030	ул Некрасова д.10
161	6cc9686c162d21334d91fbe4b10f1891	1	Павел	1231461030	ул Некрасова д.10
162	8d12b224b2e4e20fcc89743b45e3deb1	1	Павел	1231461030	ул Некрасова д.10
163	ea56b82c41f82fee8442f401f7a5d6db	1	Павел	1231461030	ул Некрасова д.10
164	cc158e0437a61488f0fd29cd22293d7b	1	Павел	1231461030	ул Некрасова д.10
165	6ccb0cfd87e359896b9e3b6b36108977	1	Павел	1231461030	ул Некрасова д.10
166	603f5b3fb20f044420fe96e90348af48	1	Павел	1231461030	ул Некрасова д.10
167	9e25a53f71e602bf920096f985c850b5	1	Павел	1231461030	ул Некрасова д.10
\.
...
SELECT pg_catalog.setval('public.basket_id_seq', 182, true);
...
SELECT pg_catalog.setval('public.order_id_seq', 167, true);
...
--
-- Database "postgres-test_test" dump
--
...
--
-- Name: postgres-test_test; Type: DATABASE; Schema: -; Owner: user
--

CREATE DATABASE "postgres-test_test" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';


ALTER DATABASE "postgres-test_test" OWNER TO "user";

\connect -reuse-previous=on "dbname='postgres-test_test'"
...
COPY public."user" (id, username, roles, password, user_phone, user_address, user_full_name) FROM stdin;
\.
